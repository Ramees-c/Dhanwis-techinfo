...
function ServiceCard({icon, heading, desc}) {
  return (
    <div className="w-full md:w-1/2 lg:w-1/4 mb-24">
      <div className="border border-opacity-5 border-gray-800 h-full transition-all duration-300 shadow-md lg:shadow-xl group">
