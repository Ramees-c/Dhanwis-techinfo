  ...
  return (
    <div className="w-[350px] px-4">
      <div className="relative">
        ...
        <div className="shadow-[0_0_45px_rgba(0,0,0,0.05)] h-full pb-5 mb-20  group">
          ...
          <img
            className=" -top-10 w-full  pl-[45px] transition-all duration-500 relative z-[1]"
            src={image}
            alt="Metal Works"
          />

          {/* Content */}
          <div className="pl-5 relative ml-6 z-[1]">
